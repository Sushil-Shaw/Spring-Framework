...
public class ContactService {
    ...
    public Page<Contact> fetchMessagesByStatusOpen(int pageNum, String sortField, String sortDir) {
        ...
        return contactRepository.findByStatus(SKSSchoolConstants.OPEN, pageable);
